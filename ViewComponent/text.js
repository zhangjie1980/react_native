        ...
        return (
            <View style={{flex: 1}}>
                ...
                <View style={{flex: 1}}>
                    ...
                    <ListItemComponent title="进度显示哦" navigator={this.state.navigator}/>
                    <ListItemComponent title="获取网络数据" navigator={this.state.navigator}/>
                    <ListItemComponent title="Swiper" navigator={this.state.navigator}/>
                    <ListItemComponent title="SimpleListView" navigator={this.state.navigator}/>
                    <ListItemComponent title="SectionListView" navigator={this.state.navigator}/>
